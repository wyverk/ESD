...
module nios_system_mm_interconnect_0 (
	...
	wire  [16:0] push_button_s1_agent_m0_address;                                                    // push_button_s1_agent:m0_address -> push_button_s1_translator:uav_address
	...
	wire  [93:0] push_button_s1_agent_rf_source_data;                                                // push_button_s1_agent:rf_source_data -> push_button_s1_agent_rsp_fifo:in_data
	...
	wire  [93:0] push_button_s1_agent_rsp_fifo_out_data;                                             // push_button_s1_agent_rsp_fifo:out_data -> push_button_s1_agent:rf_sink_data
	...
	wire         cmd_mux_004_src_valid;                                                              // cmd_mux_004:src_valid -> push_button_s1_agent:cp_valid
	wire  [92:0] cmd_mux_004_src_data;                                                               // cmd_mux_004:src_data -> push_button_s1_agent:cp_data
	wire         cmd_mux_004_src_ready;                                                              // push_button_s1_agent:cp_ready -> cmd_mux_004:src_ready
	wire   [6:0] cmd_mux_004_src_channel;                                                            // cmd_mux_004:src_channel -> push_button_s1_agent:cp_channel
	wire         cmd_mux_004_src_startofpacket;                                                      // cmd_mux_004:src_startofpacket -> push_button_s1_agent:cp_startofpacket
	wire         cmd_mux_004_src_endofpacket;                                                        // cmd_mux_004:src_endofpacket -> push_button_s1_agent:cp_endofpacket
	...
	wire  [16:0] hex_s1_agent_m0_address;                                                            // hex_s1_agent:m0_address -> hex_s1_translator:uav_address
	...
	wire  [93:0] hex_s1_agent_rf_source_data;                                                        // hex_s1_agent:rf_source_data -> hex_s1_agent_rsp_fifo:in_data
	...
	wire  [93:0] hex_s1_agent_rsp_fifo_out_data;                                                     // hex_s1_agent_rsp_fifo:out_data -> hex_s1_agent:rf_sink_data
	...
	wire  [92:0] cmd_mux_005_src_data;                                                               // cmd_mux_005:src_data -> hex_s1_agent:cp_data
	...
	wire  [92:0] cmd_mux_006_src_data;                                                               // cmd_mux_006:src_data -> onchip_memory2_0_s1_agent:cp_data
	...
	wire  [92:0] push_button_s1_agent_rp_data;                                                       // push_button_s1_agent:rp_data -> router_006:sink_data
	...
	wire         hex_s1_agent_rp_valid;                                                              // hex_s1_agent:rp_valid -> router_007:sink_valid
	wire  [92:0] hex_s1_agent_rp_data;                                                               // hex_s1_agent:rp_data -> router_007:sink_data
	wire         hex_s1_agent_rp_ready;                                                              // router_007:sink_ready -> hex_s1_agent:rp_ready
	wire         hex_s1_agent_rp_startofpacket;                                                      // hex_s1_agent:rp_startofpacket -> router_007:sink_startofpacket
	wire         hex_s1_agent_rp_endofpacket;                                                        // hex_s1_agent:rp_endofpacket -> router_007:sink_endofpacket
	...
	wire  [92:0] onchip_memory2_0_s1_agent_rp_data;                                                  // onchip_memory2_0_s1_agent:rp_data -> router_008:sink_data
	...
	wire         push_button_s1_agent_rdata_fifo_src_valid;                                          // push_button_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_004:in_0_valid
	wire  [33:0] push_button_s1_agent_rdata_fifo_src_data;                                           // push_button_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_004:in_0_data
	wire         push_button_s1_agent_rdata_fifo_src_ready;                                          // avalon_st_adapter_004:in_0_ready -> push_button_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_004_out_0_valid;                                                  // avalon_st_adapter_004:out_0_valid -> push_button_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_004_out_0_data;                                                   // avalon_st_adapter_004:out_0_data -> push_button_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_004_out_0_ready;                                                  // push_button_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_004:out_0_ready
	wire   [0:0] avalon_st_adapter_004_out_0_error;                                                  // avalon_st_adapter_004:out_0_error -> push_button_s1_agent:rdata_fifo_sink_error
