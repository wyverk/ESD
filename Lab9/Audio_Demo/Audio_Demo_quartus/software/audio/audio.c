...
// Global variables
#define MAX_SAMPLES 				 96000  //max sample data (16 bits each) for SDRAM
...
uint16* FilterPtr	= (uint16*)FILTER_0_BASE;
uint32* SW_ptr		= (uint32*)PIO_0_BASE;
